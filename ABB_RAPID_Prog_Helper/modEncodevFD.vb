Module modEncodevFD
	...
	Public Function GetEncodeFileVFD(ByVal strFileToEncode As String, ByVal strFileOutput As String) As Boolean
		...
		If Not My.Computer.FileSystem.FileExists(strFileToEncode) Then
			MsgBox(String.Format(My.Resources.NoFileExist, strFileToEncode) _
				  , MsgBoxStyle.Critical, "modEncodevFD.GetEncodeFileVFD ")
			Exit Function
		End If
		...
		If My.Computer.FileSystem.FileExists(strFileOutput) Then
			intChar = MsgBox(String.Format(My.Resources.FileAlreadyExist, strFileOutput) _
							, MsgBoxStyle.Critical + MsgBoxStyle.YesNo, "modEncodevFD.GetEncodeFileVFD ")
