Module modDecodevFD
	...
	Public Function GetDecodeFileVFD(ByVal strFileToDecode As String, ByVal strFileOutput As String, Optional ByVal blShowMessNoCrypted As Boolean = False) As Boolean
		...
		If Not My.Computer.FileSystem.FileExists(strFileToDecode) Then
			MsgBox(String.Format(My.Resources.NoFileExist, strFileToDecode) _
				  , MsgBoxStyle.Critical, "modDecodevFD.GetDecodeFileVFD ")
			Exit Function
		End If
		...
		If My.Computer.FileSystem.FileExists(strFileOutput) Then
			intChar = MsgBox(String.Format(My.Resources.FileAlreadyExist, strFileOutput) _
							, MsgBoxStyle.Critical + MsgBoxStyle.YesNo, "modDecodevFD.GetDecodeFileVFD ")
		...
		For lngCurs = LBound(bytFileToDecode) To UBound(bytFileToDecode)
			...
			'Select Case Loc(1)
			Select Case lngCurs
				Case 0, 3 To (intStartCoding - 1)
					'Entête "FD XX XX A0 3D 52 00 84 F9 13 00 B0 16 40 00 7C 02 02 "
				Case 1
